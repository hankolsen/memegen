...
})({"16J1P":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "8549c0bb2f7d6f50";
module.bundle.HMR_BUNDLE_ID = "eb4082dc964759e9";
"use strict";
...
},{}],"47O2N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _meow = require("meow");
var _meowDefault = parcelHelpers.interopDefault(_meow);
var _generator = require("./generator");
var _generatorDefault = parcelHelpers.interopDefault(_generator);
const main = async ()=>{
    const cli = (0, _meowDefault.default)(`
...
},{"meow":"meow","./generator":"iHHow","@parcel/transformer-js/src/esmodule-helpers.js":"hCTA4"}],"iHHow":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var $parcel$__dirname = require("37f9a46b206a3b74").resolve(__dirname, "../src");
const fitText = ({ ctx, x, y, text, fontSize, fromBottom = false })=>{
    ...
    if (lines.length > maxLines) fitText({
        ctx,
        x,
        y,
        fontSize: fontSize - 5,
...
const writeMeme = (canvas, output)=>{
    ...
    const out = (0, _fsDefault.default).createWriteStream(output);
    stream.pipe(out);
...
const getCanvas = ({ width, image })=>{
    ...
    (0, _canvas.registerFont)(`${$parcel$__dirname}/assets/fonts/impact.ttf`, {
        family: "Impact"
    });
...
const generator = async ({ width = 500, imagePath = `${$parcel$__dirname}/assets/images/That-Would-Be-Great.jpg`, topText = "", bottomText = "", output = "" } = {})=>{
    const image = await (0, _canvas.loadImage)(imagePath);
    const { canvas, height } = getCanvas({
        width,
        image
    });
    writeText({
    ...
    if (output) writeMeme(canvas, output);
    // eslint-disable-next-line no-console
    console.log("Done! Just paste the content of your clipboard wherever you want the image");
};
exports.default = generator;

},{"37f9a46b206a3b74":"path","canvas":"canvas","img-clipboard":"img-clipboard","fs":"fs","path":"path","@parcel/transformer-js/src/esmodule-helpers.js":"hCTA4"}],"hCTA4":[function(require,module,exports) {
...
},{}]},["16J1P","47O2N"], "47O2N", "parcelRequirec4cf")
